# Airport Code Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:airportcodeconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.airportcodeconverter.AirportCodeConverterAPIClient;
import com.apiverve.airportcodeconverter.APIResponse;
import com.apiverve.airportcodeconverter.APIException;

// Initialize the client
AirportCodeConverterAPIClient client = new AirportCodeConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("code", "MCI");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/airportcodeconverter](https://docs.apiverve.com/ref/airportcodeconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/airportcodeconverter](https://docs.apiverve.com/ref/airportcodeconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/airportcodeconverter-api/issues)
