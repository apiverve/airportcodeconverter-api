...
namespace APIVerve\Airportcodeconverter;
...
/**
 * Client for the Airport Code Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/airportcodeconverter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/airportcodeconverter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AirportcodeconverterClient] {$message}\n";
        }
    }
}
