...
namespace APIVerve.API.AirportCodeConverter
{
    ...
    /// <summary>
    /// Client for the AirportCodeConverter API
    /// </summary>
    public class AirportCodeConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/airportcodeconverter";
        ...
        public AirportCodeConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AirportCodeConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AirportCodeConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AirportCodeConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AirportCodeConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(AirportCodeConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AirportCodeConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AirportCodeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AirportCodeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AirportCodeConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AirportCodeConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AirportCodeConverterQueryOptions options)
        {
